...
class MotorButtonBinding {
    ...
    // "..." means you can pass any amout of values for one argument, it is stored
    // as an array (see line 9)
    public MotorButtonBinding(double speed, SpeedController... motors) {
        this.motors = motors; // see line 9
        this.speed = speed; // see line 11
    }

    // if "expression" is true, start the motor at a certain speed stored in "speed"
    // (see line 11)
    // you can do "SetMotors(driver1.getXButton())" to bind all of
    // the motors in motors array (see line 9) to the X button on the driver1
    // controller
    // so if you press X on driver1, the motors you specified for this
    // MotorButtonBinding
    // will turn on
